...
import itserthere.displaymodifier.transformations.UserTransformations;
...
public class UserTransformationHandler {
    ...
    public static void saveUserTransformations() {
    ...
    public static void loadUserTransformations() {
        if (!PRESET_FOLDER.exists() || !PRESET_FILE.exists()) {
            initializePresets();
        }
