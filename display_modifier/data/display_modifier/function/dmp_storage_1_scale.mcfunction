...
$execute store result entity @n[type=item_frame] Item.components.minecraft:custom_data.display_settings.$(path) float 1 run scoreboard players get @s temp_obj